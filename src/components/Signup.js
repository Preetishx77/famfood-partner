...
const register = async () => {
  try{
    ...
    >
      ...
      <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12 -mt-6">
        <div>
          <img alt="alt"
              src={logo}
            class="w-48 mx-auto"
        ...
        <div className="mt-2 flex flex-col items-center">
          ...
          <div className="w-full flex-1 mt-4">
            ...
            <div class="mx-auto max-w-xs">
              ...
              />
              <button
               onClick={(password !== '' && password === confirmPassword) ? register : null}
              ...
              <p className="mx-auto text-center mt-3">Already have an account ? <span className="text-blue-700 hover:text-purple-500"> <a  href="/login" > Log In  </a></span></p>
            </div>
